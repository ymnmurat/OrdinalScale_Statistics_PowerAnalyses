...
ordinalScaleStats=function(dataset,refgroup=NULL,decreasingGrades=T,dummie=F, showSign=T,padjval=F,pcorrection='dunnettx',colorpalette="BuGn",spineplot_x='Exposures',spineplot_y='Frequency of the fibrin deposition scores',width_plot=16, height_plot=12, res_plot=300){
  require(tidyverse)
  require(reshape2)
  require(emmeans)
  suppressWarnings({
